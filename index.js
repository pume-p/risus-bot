...
function updatestat() {
    client.channels.cache.get('731715856840785951').setName('total member : ' + client.guilds.cache.get('685745431107338271').member.cache.filter(member => !member.user.bot).size);
}
